...
<head>
  ...
  <script src="daugavpils.js" type="text/javascript"></script>
...
<hr>
    ...
    <div class="row">
      <div class=" col-12 text-center">
        <h1 style="text-decoration: underline;font-size: 5vh"><strong>Daugavpils</strong></h1>
        ...
        <div class="col-12 col-sm-4">
          ...
          <h3 style="font-size: 5vh;color: #52B140">39,11% <i class="fas fa-long-arrow-alt-up"></i></h3>
        </div>
        <div class="col-12 col-sm-4">
          
          <h2 style="font-size: 5vh"><strong></strong></h2>
          <h5 style="font-size: 3vh;"><strong>Latvijas un pasaules vēsture</strong></h5>
          <h3 style="font-size: 5vh;">33% </h3>
        </div>
        <div class="col-12 col-sm-4">
          
          <h2 style="font-size: 5vh"><strong></strong></h2>
          <h5 style="font-size: 3vh"><strong>Latviešu valoda</strong></h5>
          <h3 style="font-size: 5vh;">43,83%</h3>
    ...
    <div class="collapse multi-collapse" id="multiCollapseExample1">
      <div class="card card-body"style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh;color: #52B140;">67,36% <i class="fas fa-long-arrow-alt-up"></i></h3>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card card-body" style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh; color: #52B140;">64,62% <i class="fas fa-long-arrow-alt-up"></i></h3>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card card-body" style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh;color: #52B140;">47,77%<i class="fas fa-long-arrow-alt-up"></i></h3>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card card-body" style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh;color: #52B140;">85% <i class="fas fa-long-arrow-alt-up"></i></h3>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card card-body" style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh;color: #52B140;">83,97% <i class="fas fa-long-arrow-alt-up"></i></h3>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card " style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh;">50,77%</h3>
      </div>
    </div>
  </div>
  <div class="col">
...
<div class="row">
  <div class="col-12 text-center">
    <strong><h1 style="font-size: 5vh">Daugavpils vispārizglītojošo skolu eksāmenu rezultāti (%)<h1></strong>
  </div>
</div>
