...
<head>
  ...
  <script src="jelgava.js" type="text/javascript"></script>
...
<hr>
    ...
    <div class="row">
      <div class=" col-12 text-center">
        <h1 style="text-decoration: underline;font-size: 5vh"><strong>Jelgava</strong></h1>
    ...
    <div class="collapse multi-collapse" id="multiCollapseExample1">
      <div class="card card-body"style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh;">55,29%</h3>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card card-body" style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh;">59,23%</h3>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card card-body" style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh;color: #52B140;">40,9%<i class="fas fa-long-arrow-alt-up"></i></h3>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card card-body" style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh;">68,14% </h3>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card card-body" style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh;color: #52B140;">88% <i class="fas fa-long-arrow-alt-up"></i></h3>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card " style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh;color: #52B140; ">64,15% <i class="fas fa-long-arrow-alt-up"></i></h3>
      </div>
    </div>
  </div>
  <div class="col">
...
<div class="row">
  <div class="col-12 text-center">
    <strong><h1 style="font-size: 5vh">Jelgavas vispārizglītojošo skolu eksāmenu rezultāti (%)<h1></strong>
  </div>
</div>
