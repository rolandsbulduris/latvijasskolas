...
<head>
  ...
  <script src="riga.js" type="text/javascript"></script>
...
<hr>
    ...
    <div class="row">
      <div class=" col-12 text-center">
        <h1 style="text-decoration: underline;font-size: 5vh"><strong>Rīga</strong></h1>
        ...
        <div class="col-12 col-sm-4">
          ...
          <h3 style="font-size: 5vh;color: #52B140;">35,51% <i class="fas fa-long-arrow-alt-up"></i></h3>
        </div>
        <div class="col-12 col-sm-4">
          
          <h2 style="font-size: 5vh"><strong></strong></h2>
          <h5 style="font-size: 3vh;"><strong>Latvijas un pasaules vēsture </strong></h5>
          <h3 style="font-size: 5vh;color: #52B140;">40,69% <i class="fas fa-long-arrow-alt-up"></i></h3>
        </div>
        <div class="col-12 col-sm-4">
          
          <h2 style="font-size: 5vh"><strong></strong></h2>
          <h5 style="font-size: 3vh"><strong>Latviešu valoda</strong></h5>
          <h3 style="font-size: 5vh">51,33%</h3>
    ...
    <div class="collapse multi-collapse" id="multiCollapseExample1">
      <div class="card card-body"style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh;color: #52B140;">65,38% <i class="fas fa-long-arrow-alt-up"></i></h3>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card card-body" style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh;color: #52B140;">62,98% <i class="fas fa-long-arrow-alt-up"></i></h3>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card card-body" style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh;color: #52B140;">41,33%  <i class="fas fa-long-arrow-alt-up"></i></h3>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="collapse multi-collapse" id="multiCollapseExample1">
      <div class="card card-body"style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh">67,88</h3>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card card-body" style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh;color: #52B140;">71,16%  <i class="fas fa-long-arrow-alt-up"></i></h3>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card card-body" style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh;color: #52B140;">73,74 <i class="fas fa-long-arrow-alt-up"></i></h3>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="collapse multi-collapse" id="multiCollapseExample2">
      <div class="card " style="background-color: rgb(0,0,0,0.5)">
        <h2 style="font-size: 5vh"><strong></strong></h2>
          ...
          <h3 style="font-size: 5vh;color: #52B140;">63,8% <i class="fas fa-long-arrow-alt-up"></i></h3>
      </div>
    </div>
  </div>
  <div class="col">
...
<div class="row">
  <div class="col-12 text-center">
    <strong><h1 style="font-size: 5vh">Rīgas vispārizglītojošo skolu eksāmenu rezultāti (%)<h1></strong>
  </div>
</div>
